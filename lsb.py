...
Original file is located at
    https://colab.research.google.com/drive/1u9Fb987LfgfHKkcHF1rlmnTW5Qi_73RC
"""
...
def Steganography():
    ...
    if (userinput == 1):
      ...
      encoded_image = hideData(image, text) # call the hideData function to hide the secret message into the selected image
      print(encoded_image)
